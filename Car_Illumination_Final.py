...
init_frame = increase_brightness(init_frame,30)
...
while cap.isOpened():
	...
	cur_frame = increase_brightness(cur_frame,50)
	#cur_frame = cv2.dilate(cur_frame, kernel, 1)
	...
	img = cv2.rectangle(OG, (x1, y1), (x2, y2), (200, 0, 0), 3)
	cv2.imshow("tracker", img)
	#cv2.imwrite("T2/Car{}.png".format(frames), img)
